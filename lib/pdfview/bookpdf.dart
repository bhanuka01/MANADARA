...
import 'package:sinbook/pdfview/pdfview.dart';

class BookPDF extends StatefulWidget {
  final String url1;
  const BookPDF(this.url1, {super.key});

  @override
  State<BookPDF> createState() => _ContentpageState();
}

class _ContentpageState extends State<BookPDF> {
  List<dynamic> users = [];
                  ...
                  title: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PdfViewPage(url1),
                          ),
                        );
                      },
                      child: Text(subtitle)),
